  ...
  return (
    <>
      <style>{`
        ...
        .shell-left { display: flex; align-items: center; gap: 0; }
        ...
        /* ── Back button: 100% larger & more prominent ── */
        .shell-back {
          font-family: var(--font-mono);
          font-size: 14px;           /* was ~10px, now 14px = ~100% bigger */
        ...
        .shell-back::after {
          content: '';
          position: absolute; bottom: -1px; left: 20px; right: 0;
        ...
        .user-btn {
          ...
          color: var(--text-dim); border: 1px solid var(--border); background: var(--panel);
        ...
        .auth-link {
          font-family: var(--font-mono);
          font-size: var(--mono-sm); letter-spacing: 0.12em; text-transform: uppercase;
      ...
      <div className="margin-left" aria-hidden="true">
        <div className="margin-diamond" />
        <div className="margin-dot" />
              ...
              <div className="user-menu-wrap">
                ...
                {menuOpen && (
                  <div className="user-dropdown">
                    <div className="user-dropdown-item" style={{ color:"var(--text-bright)", cursor:"default" }}>{user.email}</div>
